...
''' </summary>
''' <remarks></remarks>
Public Class BS0002SESSION : Implements IDisposable

    ''' <summary>
    ''' INIファイルデータの管理
    ''' </summary>
    Private Shared SESSION As Hashtable = Nothing

    Public Sub New()
        If IsNothing(SESSION) Then
            Using BS0001INIFILEget As New BS0001INIFILEget
                SESSION = New Hashtable
                BS0001INIFILEget.GetINIFILE()
            End Using
        End If
    End Sub
